...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Highlight) DeepCopyInto(out *Highlight) {
	*out = *in
	if in.MaxAnalyzedOffset != nil {
		in, out := &in.MaxAnalyzedOffset, &out.MaxAnalyzedOffset
		*out = new(intstr.IntOrString)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Highlight.
func (in *Highlight) DeepCopy() *Highlight {
	if in == nil {
		return nil
	}
	out := new(Highlight)
